    ...
    namespace test {
        ...
        namespace TestGroup {
            ...
            class MessageInGroup implements jspb.test.TestGroup.MessageInGroup.$Properties {
                ...
                static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): jspb.test.TestGroup.MessageInGroup;
                static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): jspb.test.TestGroup.MessageInGroup;
                static verify(message: { [k: string]: any }): (string|null);
            ...
            namespace MessageInGroup {
                ...
                class NestedMessage implements jspb.test.TestGroup.MessageInGroup.NestedMessage.$Properties {
                    ...
                    static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): jspb.test.TestGroup.MessageInGroup.NestedMessage;
                    static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): jspb.test.TestGroup.MessageInGroup.NestedMessage;
                    static verify(message: { [k: string]: any }): (string|null);
            ...
            class EnumInGroup implements jspb.test.TestGroup.EnumInGroup.$Properties {
                ...
                static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): jspb.test.TestGroup.EnumInGroup;
                static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): jspb.test.TestGroup.EnumInGroup;
                static verify(message: { [k: string]: any }): (string|null);
        ...
        class TestMessageWithOneof implements jspb.test.TestMessageWithOneof.$Properties {
            ...
            static create(properties: jspb.test.TestMessageWithOneof.$Shape): jspb.test.TestMessageWithOneof & jspb.test.TestMessageWithOneof.$Oneofs;
            ...
            static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): jspb.test.TestMessageWithOneof & jspb.test.TestMessageWithOneof.$Oneofs;
            static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): jspb.test.TestMessageWithOneof & jspb.test.TestMessageWithOneof.$Oneofs;
            static verify(message: { [k: string]: any }): (string|null);
